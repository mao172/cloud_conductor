  ...
  describe 'CloudAPI' do
    ...
    describe 'GET /clouds' do
      ...
      context 'administrator', admin: true do
        ...
        it 'Get cloud list', autodoc: true do
    ...
    describe 'GET /clouds/:id' do
      ...
      context 'administrator', admin: true do
        ...
        it 'Get specified cloud information', autodoc: true do
          expect(subject.body).to match_json_expression(result)
        end
      end
    ...
    describe 'POST /clouds' do
      ...
      context 'administrator', admin: true do
        ...
        it 'Register cloud', autodoc: true do
          expect(subject.body).to match_json_expression(result)
        end
      end
    ...
    describe 'PUT /clouds/:id' do
      ...
      context 'administrator', admin: true do
        ...
        it 'Update cloud information', autodoc: true do
          expect(subject.body).to match_json_expression(result)
        end
      end
    ...
    describe 'DELETE /clouds/:id' do
      ...
      context 'administrator', admin: true do
        ...
        it 'Delete cloud', autodoc: true do
