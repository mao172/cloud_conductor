  ...
  describe 'BlueprintAPI' do
    ...
    describe 'GET /blueprints' do
      ...
      context 'administrator', admin: true do
        ...
        it 'Get blueprint list', autodoc: true do
    ...
    describe 'GET /blueprints/:id' do
      ...
      context 'administrator', admin: true do
        ...
        it 'Get specified blueprint information', autodoc: true do
          expect(subject.body).to match_json_expression(result)
        end
      end
    ...
    describe 'POST /blueprints' do
      ...
      context 'administrator', admin: true do
        ...
        it 'Create blueprint', autodoc: true do
          expect(subject.body).to match_json_expression(result)
        end
      end
    ...
    describe 'PUT /blueprints/:id' do
      ...
      context 'administrator', admin: true do
        ...
        it 'Update blueprint information', autodoc: true do
          expect(subject.body).to match_json_expression(result)
        end
      end
    ...
    describe 'POST /blueprints/:id/build' do
      ...
      context 'administrator', admin: true do
        ...
        it 'Build blueprint history with images from blueprint', autodoc: true do
          expect(subject.body).to match_json_expression(result)
        end
      end
